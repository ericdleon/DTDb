    ...
    <section class="nav-trail">
        ...
        <div class="mini-nav">
	        <ul>
                ...
                <li>
	                <a  <?php if ($CURRENT_PAGE == "User Homeage") {?>active<?php }?> href="/Playground/Mod-Pages/mod-laptops.php">Laptops</a>
                </li>
	        </ul>
        </div>
...
?>
    ...
    <div class="device-grid">
        <div class="device-box">
            ...
            <p><b>Processor:</b> <?php echo $pro1->proc_name; ?></p>
            <p><b>Graphics Card:</b> <?php echo $pro1->graphic_card_name; ?></p>
        </div>
        <div class="device-box">
            ...
            <p><b>Processor:</b> <?php echo $pro2->proc_name; ?></p>
            <p><b>Graphics Card:</b> <?php echo $pro2->graphic_card_name; ?></p>
        </div>
    </div>
