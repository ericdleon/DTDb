...
<div class="grid-container">
    ...
    <?php
        if (isset($_POST['submit-search'])) {
            ...
            echo "<h2 class='nav-trail'>";
            echo "There are ".$queryResult." results for '".$search."'";
            echo "</h2>";
            ...
            if ($queryResult > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    echo "<a href='mod_device_page.php?manu_name=".$row['manu_name']."&device_type=".$row['device_type']."&upgrade_price=".$row['upgrade_price']."'><div class='device-box'>
