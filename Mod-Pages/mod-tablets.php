...
<div class="grid-container">
    ...
    <section class="nav-trail">
        ...
        <div class="mini-nav">
	        <ul>
	            <li>
	                <a  <?php if ($CURRENT_PAGE == "User Homepage") {?>active<?php }?> href="/Playground/Mod-Pages/mod-homepage.php">Home</a>
                </li>
            </ul>
        </div>
    ...
    <div class="mod_compare_position" id="btn_compare" style="display: none;">
                <form action="mod_compare_device_page_tablet.php" method="POST">
