...
<div class="grid-container">
    ...
    <section class="nav-trail">
        ...
        <div class="mini-nav">
	        <ul>
	            <li>
	                <a  <?php if ($CURRENT_PAGE == "User Homeage") {?>active<?php }?> href="/Playground/Mod-Pages/mod-homepage.php">Home</a>
                </li>
                <li>
	                <a  <?php if ($CURRENT_PAGE == "User Homeage") {?>active<?php }?> href="/Playground/Mod-Pages/mod-manufacturers.php">Manufacturers</a>
                </li>
	        </ul>
        </div>
    </section>
            ...
            ?>
               <div class="device-box">
                   <div class="card compare_card<?php echo $row['device_id']; ?><?php echo $row['storage_size']; ?>">
                       ...
                       <a href="http://ejd110.rutgers-sci.domains/Playground/Mod-Pages/mod_device_page.php?manu_name=<?php echo $row['manu_name']; ?>&device_type=<?php echo $row['device_type']; ?>&upgrade_price=<?php echo $row['upgrade_price']; ?>">
