...
<div class="grid-container">
    ...
    <section class="nav-trail">
        ...
        <div class="mini-nav">
	        <ul>
                ...
                <li>
	                <a  <?php if ($CURRENT_PAGE == "User Homepage") {?>active<?php }?> href="/Playground/Admin-Pages/admin-add-screen.php">Add Component</a>
                </li>
            </ul>
        </div>
    ...
    <main>
      <a href="insert-device.php">
        <div class="box">
          <img src="../images/factory.svg" alt="">
          Cellphones/Tablets
        </div>
      </a>
      <a href="insert-device-laptop.php">
        <div class="box">
          <img src="../images/factory.svg" alt="">
          Laptops
        </div>
