...
<div class="grid-container">
    ...
    <main>
    <form class="content" method="POST" action="insert-storage-size-process.php">
			<p>Enter a Storage Size into the Storage_Sizes Table  </p>
		  	<p>Storage ID: 
          		<input type="text" name="storage_id"/>
		  	</p>
		  	<p>Storage Size:
			  	<input type="text" name="storage_size"/></p>			  
